...
<template>
  ...
  <main id="qa-main" ref="main" tabindex="-1" class="page-shell qa-page">
    ...
    <section class="community-panel faq" aria-labelledby="faq-title"><p class="eyebrow">Q & A</p><h2 id="faq-title">先回答几个小问题</h2><details open><summary>建议和留言有什么区别？</summary><p>建议会公开提交为 GitHub Issue，方便跟进功能、店铺推荐和内容纠错；日常交流可以到 B 站主页私信。</p></details><details><summary>为什么需要 GitHub 账号？</summary><p>提交建议和参与 Issue 讨论需要 GitHub 账号；日常私信请在 B 站登录后发送。阅读网站内容无需登录。</p></details><details><summary>访问次数怎么计算？</summary><p>打开或刷新榜单、地图或 QA 页面计一次访问，不按 IP 去重。页面内筛选、点击按钮不会重复计数；次数不等于独立访客人数。</p><p>由不蒜子提供统计。网络或拦截器可能影响加载，统计不可用时不会显示虚构数字。</p></details><details><summary>现在为什么没有店铺？</summary><p>网站已准备好，真实体验会由作者逐步补充。可以先把想推荐的店铺和城市写进建议。</p></details></section></div>
